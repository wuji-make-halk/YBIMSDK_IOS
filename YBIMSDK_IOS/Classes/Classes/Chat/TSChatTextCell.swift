...
//        contentLabel.debugOption = self.debugYYLabel()
    ...
    class func layoutHeight(_ model: ChatModel) -> CGFloat {
        ...
        //解析富文本
        let attributedString = TSChatTextParser.parseText(model.payload?.removingPercentEncoding ?? " ", font: kChatTextFont)!
        ...
        height += max(stringHeight + kChatBubbleHeightBuffer + kChatBubbleBottomTransparentHeight, kChatBubbleImageViewHeight + 20)
