...
//        let bundle = Bundle(for: tscha)
        ...
        self.chatActionBarView.snp.makeConstraints { [weak self] (make) -> Void in
            ...
            if #available(iOS 11.0, *) {
                strongSelf.actionBarPaddingBottomConstranit = make.bottom.equalTo(strongSelf.view.safeAreaLayoutGuide.snp.bottom).constraint
            } else {
...
//        self.emotionInputView.isHidden = true
...
//        self.shareMoreView.isHidden = true
...
extension YBChatViewController: UIGestureRecognizerDelegate {
