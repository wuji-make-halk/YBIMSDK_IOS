...
extension UIImage {
    enum Asset : String {
        ...
        case Emotion_delete = "compose_emotion_delete_highlighted"
        ...
        case Tool_emotion_1 = "ToolViewEmotion"
        case Tool_emotion_2 = "ToolViewEmotionHL"
        case Tool_keyboard_1 = "ToolViewKeyboard"
        case Tool_keyboard_2 = "ToolViewKeyboardHL"
        case Tool_share_1 = "TypeSelectorBtn_Black"
        case Tool_share_2 = "TypeSelectorBtnHL_Black"
        case Tool_voice_1 = "ToolViewInputVoice"
        case Tool_voice_2 = "ToolViewInputVoiceHL"
        ...
        var image: UIImage {
            let bundlePath = Bundle.init(for: YBChatViewController.self).path(forResource: self.rawValue + "@2x", ofType: "png")
